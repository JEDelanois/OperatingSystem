 ...
 * is full.
 put opcode followed by bytes to send to tux controler here
 */
extern int tuxctl_ldisc_put(struct tty_struct*, char const*, int);// first line of contst is opcode the rest is the data
